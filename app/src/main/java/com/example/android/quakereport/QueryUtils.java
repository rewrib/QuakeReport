...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return a list of {@link Earthquake} object to represent a single earthquake.
     */
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        // Extract relevant fields from the JSON response and create a list of {@link Earthquake} object
